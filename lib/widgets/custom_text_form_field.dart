...
class CustomTextFormField extends StatelessWidget {
  ...
  Widget textFormFieldWidget(BuildContext context) => SizedBox(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.bodyMediumGray600b2,
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.bodyMediumBlack9000213_2,
        prefixIcon: prefix,
...
extension TextFormFieldStyleHelper on CustomTextFormField {
  static OutlineInputBorder get outlineBlack => OutlineInputBorder(
        borderRadius: BorderRadius.circular(10.h),
        borderSide: BorderSide(
          color: appTheme.black90002.withOpacity(0.85),
          width: 1,
        ),
      );
